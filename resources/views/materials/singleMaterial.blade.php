                    ...
                    <div>
                        <div>
                            <div>
                                ...
                                <img style="border-radius:10px; width: 100%; height: 100%;" src="/storage/material_images/{{$company->companyId}}/{{$material->photo1}}" alt="material">
                                <div class="content-details fadeIn-bottom">
                                    <h3 style="text-align: center" class="mx-auto">{!!$material->description!!}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
